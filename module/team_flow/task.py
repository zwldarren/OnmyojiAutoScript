...
class Task:
    ...
    def update_info(self, next_run: datetime, limit_time: time, limit_count: int, role: str):
        # next_run
...
if __name__ == "__main__":
    host = Task(
        next_run=datetime.fromisoformat("2023-09-13 18:46:23"),
    ...
    test1 = Task(
        next_run=datetime.fromisoformat("2023-09-13 18:44:23"),
        limit_time=time.fromisoformat("00:30:00"),
        target_run=datetime.fromisoformat("2023-09-13 18:46:23"),
        team_task=True,
        role="leader",
