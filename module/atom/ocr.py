...
from module.ocr.sub_ocr import Digit, DigitCounter, Duration, Full, Quantity, Single
...
if __name__ == "__main__":
    ...
    O_MALL_RESOURCE_2 = RuleOcr(
        roi=(326, 8, 124, 39),
        area=(326, 8, 124, 39),
        mode="Quantity",
        method="Default",
        keyword="",
        name="mall_resource_2",
    )
    O_MALL_RESOURCE_3 = RuleOcr(
        roi=(533, 9, 107, 38),
        area=(533, 9, 107, 38),
        mode="Quantity",
        method="Default",
        keyword="",
        name="mall_resource_3",
    )
    O_MALL_RESOURCE_4 = RuleOcr(
        roi=(739, 8, 100, 39),
        area=(739, 8, 100, 39),
        mode="Quantity",
        method="Default",
        keyword="",
        name="mall_resource_4",
    )
    O_MALL_RESOURCE_5 = RuleOcr(
        roi=(935, 11, 100, 37),
        area=(935, 11, 100, 37),
        mode="Quantity",
        method="Default",
        keyword="",
        name="mall_resource_5",
    )
    O_MALL_RESOURCE_6 = RuleOcr(
        roi=(1129, 6, 100, 41),
        area=(1129, 6, 100, 41),
        mode="Quantity",
        method="Default",
        keyword="",
        name="mall_resource_6",
    )
