...
class ShopConfig(BaseModel):
    time_of_mystery: Time = Field(
        default=Time(hour=0, minute=0, second=0), description="time_of_mystery_help"
    )
...
class ShareConfig(BaseModel):
    ...
    share_friend_1: str = Field(
        title="Share Friend 1", default="", description="share_friend_1_help"
    )
