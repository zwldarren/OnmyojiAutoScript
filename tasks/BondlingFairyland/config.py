...
class BondlingConfig(ConfigBase):
    ...
    bondling_mode: BondlingMode = Field(
        default=BondlingMode.MODE1, description="bondling_mode_help"
    )
    ...
    bondling_stone_class: BondlingClass = Field(
        default=BondlingClass.TOMB_GUARD, description="bondling_stone_class_help"
    )
