...
from tasks.GameUi.page import page_main, page_shikigami_records, page_team


class ScriptTask(
    GameUi, GeneralBattle, GeneralRoom, GeneralInvite, SwitchSoul, ExperienceYoukaiAssets
):
    def run(self):
        # 切换御魂
        ...
        if self.config.experience_youkai.switch_soul.enable_switch_by_name:
            ...
            self.run_switch_soul_by_name(
                self.config.experience_youkai.switch_soul.group_name,
