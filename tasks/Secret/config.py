...
class SecretConfig(BaseModel):
    secret_gold_50: bool = Field(
        title="Secret Gold 50", default=False, description="secret_gold_50_help"
    )
    secret_gold_100: bool = Field(
        title="Secret Gold 100", default=False, description="secret_gold_100_help"
    )
