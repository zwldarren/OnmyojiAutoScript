...
page_climb_act_2.additional = [
    asa.I_ACT_MAP_SWITCH,
    asa.I_PASS_ACT_LOCAT,
    asa.I_SKIP_BUTTON,
    asa.I_RED_EXIT,
    asa.I_RED_EXIT_2,
]
...
page_climb_act_pass.additional = [
    asa.I_SKIP_BUTTON,
    gga.I_UI_REWARD,
    asa.I_RED_EXIT,
]
...
page_climb_act_ap.additional = [
    asa.O_ENTRY_ACTIVITY,
    asa.I_SKIP_BUTTON,
    asa.I_TOGGLE_BUTTON,
    gga.I_UI_REWARD,
    asa.I_RED_EXIT,
