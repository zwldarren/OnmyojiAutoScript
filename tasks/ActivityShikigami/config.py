...
class GeneralBattleConfig(BaseModel):
    enable_pass_preset: bool = Field(
        default=False, description="是否切换门票爬塔预设, 仅数字切换御魂可用"
    )
    enable_pass_green: bool = Field(default=False, description="是否开启门票爬塔绿标")
    pass_green_mark: GreenMarkType = Field(
        default=GreenMarkType.GREEN_LEFT1, description="门票爬塔绿标位置"
    )
    enable_pass_anti_detect: bool = Field(
        default=False, description="门票爬塔战斗过程是否随机点击或滑动"
    )

    enable_ap_preset: bool = Field(
        default=False, description="是否切换体力爬塔预设, 仅数字切换御魂可用"
    )
    enable_ap_green: bool = Field(default=False, description="是否开启体力爬塔绿标")
    ap_green_mark: GreenMarkType = Field(
        default=GreenMarkType.GREEN_LEFT1, description="体力爬塔绿标位置"
    )
    enable_ap_anti_detect: bool = Field(
        default=False, description="体力爬塔战斗过程是否随机点击或滑动"
    )

    enable_boss_preset: bool = Field(
        default=False, description="是否切换boss爬塔预设, 仅数字切换御魂可用"
    )
    enable_boss_green: bool = Field(default=False, description="是否开启boss爬塔绿标")
    boss_green_mark: GreenMarkType = Field(
        default=GreenMarkType.GREEN_LEFT1, description="boss爬塔绿标位置"
    )
    enable_boss_anti_detect: bool = Field(
        default=False, description="boss爬塔战斗过程是否随机点击或滑动"
    )

    enable_ap100_preset: bool = Field(
        default=False, description="是否切换100体爬塔预设, 仅数字切换御魂可用"
    )
    enable_ap100_green: bool = Field(default=False, description="是否开启100体爬塔绿标")
    ap100_green_mark: GreenMarkType = Field(
        default=GreenMarkType.GREEN_LEFT1, description="100体爬塔绿标位置"
    )
    enable_ap100_anti_detect: bool = Field(
        default=False, description="100体爬塔战斗过程是否随机点击或滑动"
    )
