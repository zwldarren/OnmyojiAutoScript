...
class WantedQuestsConfig(BaseModel):
    ...
    invite_friend_name: str = Field(default="", description="invite_friend_name_help")
    cooperation_type: CooperationSelectMaskDescription = Field(
        default=CooperationSelectMaskDescription.Any, description="cooperation_type_help"
    )
    # 找怪优先级  挑战 > 秘闻 > 探索
