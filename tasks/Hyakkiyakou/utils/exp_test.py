...
from tasks.GameUi.page import page_exploration, page_main, page_town
from tasks.Restart.assets import RestartAssets
from tasks.Script.config_device import ControlMethod, ScreenshotMethod
...
class ExpTest(RightActivity, FastDevice, RestartAssets, ExplorationAssets):
    ...
    def exp_enter(self, layer: int = 25):
        ...
        x_27, y_27 = 1052, 443
        x_28, y_28 = 1052, 564
        exp_click_25 = RuleClick(
            roi_front=(x_25, y_25, w, h), roi_back=(x_25, y_25, w, h), name="exp_click_25"
        )
        exp_click_26 = RuleClick(
            roi_front=(x_26, y_26, w, h), roi_back=(x_26, y_26, w, h), name="exp_click_26"
        )
        exp_click_27 = RuleClick(
            roi_front=(x_27, y_27, w, h), roi_back=(x_27, y_27, w, h), name="exp_click_27"
        )
        exp_click_28 = RuleClick(
            roi_front=(x_28, y_28, w, h), roi_back=(x_28, y_28, w, h), name="exp_click_28"
        )
        match layer:
            case 25:
    ...
    def run_main(self):
        ...
        back_1 = Step(
            "back_1", pos=(pos_left, pos_top), time=1.7, save_img=True, save_roi=(640, 80)
        )
        step_2 = step_1
        step_2.name = "step_2"
        back_2 = Step(
            "back_2", pos=(pos_left, pos_bottom), time=1.7, save_img=True, save_roi=(640, 80)
        )
    ...
    def run_exp_base(self, pos_top: int = 550, go_times: int = 7, back_times: int = 7):
        ...
        step_1 = Step(
            "step_1", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_2 = Step(
            "step_2", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_3 = Step(
            "step_3", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_4 = Step(
            "step_4", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_5 = Step(
            "step_5", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_6 = Step(
            "step_6", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_7 = Step(
            "step_7", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
        step_8 = Step(
            "step_7", pos=(pos_right, random.randint(pos_bottom - 10, pos_bottom)), time=2.3
        )
