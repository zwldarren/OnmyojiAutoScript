...
class CostumeConfig(BaseModel):
    ...
    costume_shikigami_type: ShikigamiType = Field(
        default=ShikigamiType.COSTUME_SHIKIGAMI_DEFAULT, description="costume_shikigami_type_help"
    )
    ...
    costume_battle_type: BattleType = Field(
        default=BattleType.COSTUME_BATTLE_DEFAULT, description="costume_battle_type_help"
    )
