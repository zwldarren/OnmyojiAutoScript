...
# 结界皮肤
realm_costume_model = {
    RealmType.COSTUME_REALM_1: {
        "I_SHI_CARD": "I_SHI_CARD_1",
        "I_SHI_DEFENSE": "I_SHI_DEFENSE_1",
    },
    RealmType.COSTUME_REALM_2: {
        "I_SHI_CARD": "I_SHI_CARD_2",
...
for i in range(1, 11):
    ...
    if i == 8:  # 特殊处理第8项
        entry.update({"I_WIN": "I_WIN_8", "I_DE_WIN": "I_DE_WIN_8", "I_FALSE": "I_FALSE_8"})
...
class CostumeBase:
    ...
    def replace_img(self, asset_before: str, asset_after: RuleImage, rp_roi_back: bool = True):
