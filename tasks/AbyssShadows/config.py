...
class AbyssShadowsCombatTime(BaseModel):
    ...
    general_combat_time: int = Field(
        default=60, description="以秒为单位设置副将战斗时间，请合理设置"
    )
...
class AbyssShadows(ConfigBase):
    ...
    abyss_shadows_combat_time: AbyssShadowsCombatTime = Field(
        default_factory=AbyssShadowsCombatTime
    )
